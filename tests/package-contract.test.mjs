...
test("package scripts expose a release verification command", async () => {
  ...
  assert.equal(manifest.name, "sig9-runtime-diagnostics");
  assert.equal(manifest.scripts.start, "node standalone-server.mjs");
  assert.equal(manifest.scripts.check, "node --check standalone-server.mjs && node --check runtime-language-packets.js && node --check runtime-diagnostics.js");
